...
urlpatterns = [
    ...
    path('update_in_cash/<cash_id>/', views.update_in_cash, name='update_in_cash'),
    path('delete_in_cash/<cash_id>/', views.delete_in_cash, name='delete_in_cash'),
    ...
    # path('update_in_cashclient/<incash_id>/', views.update_in_cashclient, name='update_in_cashclient'),
    # path('delete_in_cashclient/<web>/', views.delete_in_cashclient, name='delete_in_cashclient'),
    path('out_cash_list/', views.out_cash_list, name='out_cash_list'),
    path('add_out_cash/', views.add_out_cash, name='add_out_cash'),
    path('update_out_cash/<cash_id>/', views.update_out_cash, name='update_out_cash'),
    path('delete_out_cash/<cash_id>/', views.delete_out_cash, name='delete_out_cash'),
    path('expense_list/', views.expense_list, name='expense_list'),
    path('add_expense/', views.add_expense, name='add_expense'),
    # path('update_expense/<cash_id>/', views.update_expense, name='update_expense'),
    # path('delete_expense/<cash_id>/', views.delete_expense, name='delete_expense'),
]